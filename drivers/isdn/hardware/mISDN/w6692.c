...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,27)
static void __devinit W6692Version(w6692pci *card, char *s) {
#else
static void __init W6692Version(w6692pci *card, char *s) {
#endif
	int val;
...
static int init_card(w6692pci *card)
{
	...
	if (request_irq(card->irq, (void*)w6692_interrupt, SA_SHIRQ, "w6692", card)) {
...
int __devinit setup_w6692(w6692pci *card) {
	u_int	val;
